 ...
 */
public class BaseballWebviewFragment extends Fragment {

    private static final String TAG = "BaseballWebviewFragment";
    ...
    void showQuoteAtIndex(int newIndex) {
        if (newIndex < 0 || newIndex >= mQuoteArrLen)
            return;
        mCurrIdx = newIndex;
        mQuoteView.loadUrl(BaseballActivity.mQuoteArray[mCurrIdx]);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mQuoteArrLen = BaseballActivity.mQuoteArray.length;
    }
